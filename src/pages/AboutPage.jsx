              ...
              >
                <div className="relative bg-white/5 backdrop-blur-xl rounded-3xl p-8 md:p-12 border border-white/10">
                  ...
                  <p className="text-gray-400 leading-relaxed mb-6">
                    ...
                    Since our inception, we've helped brands connect, grow, and
                    thrive in the digital world.
                  </p>
                  <p className="text-gray-400 leading-relaxed mb-6">
                    From a small team of passionate marketers and designers,
                    we've grown into a full-service agency delivering innovative
                  ...
                  <p className="text-gray-400 leading-relaxed">
                    ...
                    creativity, strategy, and relentless pursuit of excellence.
                  </p>
                </div>
              </motion.div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              >
                ...
                <p className="text-gray-400 leading-relaxed">
                  We combine cutting-edge technology with creative strategies to
                  help our clients succeed in the ever-evolving digital
                  landscape.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-400 leading-relaxed mb-6">
                  To be the leading digital marketing agency that transforms how
                  businesses connect with their audiences in the digital age.
                </p>
                <p className="text-gray-400 leading-relaxed">
                  We envision a future where every business, regardless of size,
                  can leverage the power of digital marketing to achieve their
