...
const PrivacyPolicy = () => {
  return (
    <>
      <head>
        <title>Privacy Policy | FNA Marketing Solutions</title>
        <meta
          name="description"
          content="Read FNA Marketing Solutions' Privacy Policy to learn how we collect, use, and protect your data. Your privacy and trust are our top priorities."
        />
      </head>
          ...
          <div className="space-y-10">
            ...
            <div className="card-glass p-8 rounded-3xl border border-gray-700 shadow-lg bg-zinc-900/60 backdrop-blur-md">
              ...
              <p className="text-gray-300 mb-2 leading-relaxed">
                We collect personal and non-personal information when you
            ...
            <div className="card-glass p-8 rounded-3xl border border-gray-700 shadow-lg bg-zinc-900/60 backdrop-blur-md">
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                information with trusted third parties for business purposes,
                such as:
              </p>
              <ul className="list-disc list-inside text-gray-400 space-y-1">
            ...
            <div className="card-glass p-8 rounded-3xl border border-gray-700 shadow-lg bg-zinc-900/60 backdrop-blur-md">
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                to protect your data. While we strive to protect your
