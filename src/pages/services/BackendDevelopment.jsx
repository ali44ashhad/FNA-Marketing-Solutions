...
const BackendDevelopment = () => {
  ...
  return (
    <>
      <head>
        <title>Backend Development | FNA Marketing Solutions</title>
        <meta
          name="description"
          content="Robust backend development by FNA Marketing Solutions — secure, scalable server-side architecture tailored to power your web applications."
        />
      </head>
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-400 max-w-3xl mx-auto">
                We build the engine that powers your digital presence with
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-400 max-w-3xl mx-auto">
                ...
                quality, and timely delivery of your backend systems.
              </p>
            </div>
