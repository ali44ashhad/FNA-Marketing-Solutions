            ...
            {pricingPlans.map((plan, index) => (
              <div
                ...
                className={`bg-gradient-to-b from-purple-900/20 to-blue-900/20 p-8 rounded-2xl backdrop-blur-xl border ${
                  plan.recommended ? "border-purple-500/50" : "border-white/10"
                } relative`}
              >
                {plan.recommended && (
      ...
      <section className="py-24 bg-gradient-to-b from-black to-purple-900/10 relative overflow-hidden">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Our streamlined process makes it simple to get your website online
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-10">
            Get started with our reliable hosting solutions and domain services
            today.
          </p>
          <a
            href="/contact"
