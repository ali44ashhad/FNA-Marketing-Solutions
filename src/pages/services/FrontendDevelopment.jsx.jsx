        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white/5 p-8 rounded-2xl backdrop-blur-xl border border-white/10">
              ...
              <p className="text-gray-400">
                Our services provide affordable customization options, allowing
                businesses to adapt to technological changes without maintaining
                an in-house team.
              </p>
            </div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-gradient-to-br from-purple-900/20 to-blue-900/20 p-6 rounded-2xl backdrop-blur-xl border border-white/10">
              ...
              <p className="text-gray-400 text-sm">
                Interactive applications with real-time user-server interactions
            ...
            <div className="bg-gradient-to-br from-purple-900/20 to-blue-900/20 p-6 rounded-2xl backdrop-blur-xl border border-white/10">
              ...
              <p className="text-gray-400 text-sm">
                Cloud-based software solutions accessible from multiple servers
                with distinct user data separation.
              </p>
            </div>
          </div>
        </div>
