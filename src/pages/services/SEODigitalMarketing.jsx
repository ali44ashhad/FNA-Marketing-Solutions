      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-black">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center mt-24">
          <div className="max-w-6xl mx-auto">
            ...
            >
              We develop data-driven digital marketing strategies that increase
              visibility, drive traffic, and generate qualified leads for your
              business.
            </p>
      ...
      <section className="py-24 bg-black relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Our structured marketing process ensures transparency, measurable
              results, and continuous optimization for your campaigns.
            </p>
          </div>
