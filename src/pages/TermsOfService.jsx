      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-gray-400 text-lg sm:text-xl max-w-2xl mx-auto leading-relaxed">
            ...
            Marketing Solutions website and services. By accessing or using our
        ...
        <div className="space-y-10">
          ...
          <div className="card-glass p-8 rounded-3xl border border-gray-700 shadow-lg bg-zinc-900/60 backdrop-blur-md">
            ...
            <p className="text-gray-300 leading-relaxed">
              By using our website or services, you agree to these Terms. If you
          ...
          <div className="card-glass p-8 rounded-3xl border border-gray-700 shadow-lg bg-zinc-900/60 backdrop-blur-md">
            ...
            <p className="text-gray-300 leading-relaxed">
              ...
              website are owned by FNA Marketing Solutions or its licensors. You
              may not reproduce or distribute any materials without permission.
            </p>
          </div>
          ...
          <div className="card-glass p-8 rounded-3xl border border-gray-700 shadow-lg bg-zinc-900/60 backdrop-blur-md">
            ...
            <p className="text-gray-300 leading-relaxed">
              ...
              posted on this page. Your continued use of services indicates
